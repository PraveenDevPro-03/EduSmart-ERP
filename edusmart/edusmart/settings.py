...
INSTALLED_APPS = [
    ...
    'quizzes',
    'learning',
    # 'chatbot',  # Uncomment if chatbot is enabled
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'onlinecourses0298@gmail.com'
EMAIL_HOST_PASSWORD = 'ndgo rkwl ztju paqv'
DEFAULT_FROM_EMAIL = 'EduSmart ERP <onlinecourses0298@gmail.com>'

# Security headers
X_FRAME_OPTIONS = 'SAMEORIGIN'

# OpenRouter API key (for chatbot, if enabled)
